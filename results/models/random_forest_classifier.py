...
rf_final = RandomForestClassifier(n_estimators=25, class_weight='balanced', random_state=42, max_depth=4)
rf_final.fit(X_train, y_train)

final_preds = rf_final.predict(X_test)

predictions_csv = generate_submission_csv(rf_final, X_test, id_test, "../predictions/random_forest_classifier/RF_predictions.csv")